...
#### JLRUIZ 2022: THIS SCRIPT IS NOT USE IN ILRA, BUT IF IT EVER REQUIRED, TAKE INTO ACCOUNT THE NEW "-t" ARGUMENT IN MUMMER4 TO SPECIFIY NUMBER OF THREADS IN NUCMER
